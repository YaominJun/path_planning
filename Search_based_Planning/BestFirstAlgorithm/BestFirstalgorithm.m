...
clear;clc;
filename = 'E:\6github\path_planning\Search_based_Planning\BestFirstAlgorithm\result.gif';
heap = heapFuns;
%载入地图
...
V.Q=CalculateHCost(V.x, V.y, xTarget,yTarget); 
OpenSet(1) = V;
T=[];
count=1; flag_find=0;
while flag_find==0
